...
csvwrite('precision_HC.csv',precisionList);
csvwrite('recall_HC.csv',recallList);
csvwrite('precision_average_HC.csv',averagePrecision);
csvwrite('recall_average_HC.csv',averageRecall);